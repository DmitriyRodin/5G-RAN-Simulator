...
| ID  |  Group                                      | Technical Scope                                                                                                                                                                      | status      |
|:----|:--------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------|
| 006 | Radio Environment Simulation                | Implementation of so called RadioHub that simulates the physical environment. It calculates RSSI based on distance and delivers packets only to those within the coverage area.      | In progress |
